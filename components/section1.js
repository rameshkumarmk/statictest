              ...
              <div className="form row g-0 "> 
                ...
                <div className="form-group  col-xl-3 col-lg-3 col-md-12 mb-0 bg-white position-relative dropdown text-start mx-1"> 
                  ...
                  <ul className="dropdown-menu input-lg text-lg-start" style={{width: '100%'}}>                   
                    <li><Link href="#" className="dropdown-item">Properties </Link></li>
                    <li><Link href="#" className="dropdown-item">Electronics &amp; Appliances </Link></li>
                    <li><Link href="#" className="dropdown-item">Jobs </Link></li>
                    <li><Link href="#" className="dropdown-item">Adtrology </Link></li>
                    <li><Link href="#" className="dropdown-item">Services </Link></li>
                    <li><Link href="#" className="dropdown-item">Automobiles </Link></li>
                  </ul> 
                </div> 
